...
async function  reset(req, res, next) {
    ...
    // verificar se o token são o mesmo
    if (token != user.reset_token) return res.render('password-reset',  {
        user: req.body,
        token: token,
    ...
    if(now > user.reset_token_expires) return res.render('password-reset',  {
        user: req.body,
